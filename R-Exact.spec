...
Version  : 3.1
Release  : 17
URL      : https://cran.r-project.org/src/contrib/Exact_3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Exact_3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641010333
